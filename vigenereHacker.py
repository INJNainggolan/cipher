...
import itertools, re
import vigenere_Cipher_Decrypt, pyperclip, freqAnalysis, detectEnglish
...
def attemptHackWithKeyLength(ciphertext, mostLikelyKeyLength):
    ...
    for nth in range(1, mostLikelyKeyLength + 1):
        ...
        for possibleKey in LETTERS:
            decryptedText = vigenere_Cipher_Decrypt.decryptMessage(possibleKey, nthLetters)
    ...
    for indexes in itertools.product(range(NUM_MOST_FREQ_LETTERS), repeat=mostLikelyKeyLength):
        ...
        decryptedText = vigenere_Cipher_Decrypt.decryptMessage(possibleKey, ciphertextUp)
